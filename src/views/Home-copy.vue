  ...
  >
    ...
    <div class="flex flex-col lg:flex-row gap-0 lg:gap-[2rem]">
      ...
      <div class="relative frame w-full lg:w-1/2 h-[300px] sm:h-[400px] lg:h-[492px]">
        ...
        <div
          class="absolute inset-0 flex flex-col px-4 sm:px-8 lg:px-12 py-6 sm:py-10 lg:py-12 z-10 pointer-events-none justify-between"
        >
          <!-- Logo -->
      ...
      <div class="relative frame w-full lg:w-1/2 h-[300px] sm:h-[400px] lg:h-[492px]">
        ...
        <div
          class="absolute inset-0 flex flex-col justify-between p-4 sm:p-6 lg:p-10 z-[10]"
        >
          <!-- Buttons -->
          ...
          <div class="flex justify-center">
            <div class="relative w-full sm:w-[340px] lg:w-[420px]">
              <input
                type="text"
                placeholder="Search"
                class="w-full px-3 sm:px-4 lg:px-14 py-2 rounded-xl text-xs sm:text-sm font-semibold bg-gradient-to-r from-[#ACFFCB] to-[#85A4D5] outline-none focus:outline-none focus:ring-0"
              />
              <svg
                class="absolute left-3 sm:left-4 lg:left-5 top-1/2 -translate-y-1/2 w-5 h-5 sm:w-6 sm:h-6 text-gray-500"
    ...
    <!-- Main Container -->
    <div class="w-full px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 mx-auto max-w-7xl">
        ...
        <div class="w-full grid grid-cols-2 grid-rows-2 gap-2 sm:gap-3">
          ...
          <div class="overflow-hidden rounded-lg">
            <img
              ...
              src="/public/images/WhatsApp Image 2026-01-19 at 12.36.08 PM.jpeg"
            />
          </div>
          <div class="overflow-hidden rounded-lg">
            <img
              class="w-full h-[120px] sm:h-[160px] md:h-[200px] lg:h-[130px] object-cover"
              src="/public/images/WhatsApp Image 2026-01-19 at 12.36.07 PM (3).jpeg"
            />
          </div>
        </div>
      </div>
      ...
      >
        ...
        >
          ...
          <div class="bg-[#0B0F0C] rounded-2xl overflow-hidden border border-white/5">
            ...
            <div class="relative">
              <img
                src="/public/images/WhatsApp Image 2026-01-19 at 12.36.06 PM (2).jpeg"
                class="w-full h-[180px] object-cover"
              />

              <!-- Floating Popular Badge -->
              <span
                class="absolute left-4 -bottom-3 text-[10px] font-semibold bg-[#B8FBE1] text-black px-3 py-1 rounded-full flex items-center gap-1 shadow-md"
              >
                ✦ POPULAR
              </span>
            </div>
      ...
      <!-- about us -->
      <section class="w-full grid grid-cols-1 lg:grid-cols-1 gap-10 py-16">
        <div class="lg:col-span-2">
          <h2
            class="text-4xl lg:text-5xl font-extrabold montserrat bg-gradient-to-r from-[#ACFFCB] to-[#85A4D5] bg-clip-text text-transparent"
          >
        ...
        <div
          class="text-white text-sm lg:text-base leading-relaxed flex items-start"
        ></div>
      </section>
